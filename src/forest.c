...
static void xLoadTreesLarge1(World *world)
{
    for (int i=0; i<ARRAY_COUNT(posLargeTrees); i++)
    {
        xRectangle temp =
        {
            posLargeTrees[i].x,
            posLargeTrees[i].y,
            SPRITE_TREE_LARGE.width,
            SPRITE_TREE_LARGE.height
        };
...
static void xLoadTreesSmall1(World *world)
{
    for (int i=0; i<ARRAY_COUNT(posSmallTrees); i++)
    {
        xRectangle temp =
        {
            posSmallTrees[i].x,
            posSmallTrees[i].y,
            SPRITE_TREE_SMALL.width,
            SPRITE_TREE_SMALL.height
        };
...
static void xLoadMushrooms(World *world)
{
    for (int i=0; i<ARRAY_COUNT(posMushrooms); i++)
    {
        xRectangle temp =
        {
            posMushrooms[i].x,
            posMushrooms[i].y,
            SPRITE_MUSHROOM.width,
            SPRITE_MUSHROOM.height
        };
...
static void xLoadRocks(World *world)
{
    for (int i=0; i<ARRAY_COUNT(posRocksSmall); i++)
    {
        xRectangle temp =
        {
            posRocksSmall[i].x,
            posRocksSmall[i].y,
            SPRITE_ROCK_SMALL.width,
            SPRITE_ROCK_SMALL.height
        };
...
static void xLoadTreesCut(World *world)
{
    for (int i=0; i<ARRAY_COUNT(posRocksSmall); i++)
    {
        xRectangle temp =
        {
            posTreeCuts[i].x,
            posTreeCuts[i].y,
            SPRITE_TREE_CUT.width,
            SPRITE_TREE_CUT.height
        };
...
static void xLoadTreesStump(World *world)
{
    for (int i=0; i<ARRAY_COUNT(posRocksSmall); i++)
    {
        xRectangle temp =
        {
            posTreeStumps[i].x,
            posTreeStumps[i].y,
            SPRITE_TREE_STUMP.width,
            SPRITE_TREE_STUMP.height
        };
